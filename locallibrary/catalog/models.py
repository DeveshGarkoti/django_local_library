...
class BookInstance(models.Model):
    ...
    id = models.UUIDField(
        ...
        help_text= "Unique ID for this particular book the whole library"
        )
    ...
    @property
    def is_overdue(self):
        """Determines if the book id overdue based on due date and current date."""
...
class Language(models.Model):
    """Model for defining the language"""
